...
class TravelRecommender:
    ...
    def load_data(self):
        try:
            self.data = pd.read_csv('destinations2.csv', na_values='N/A', encoding='latin1') # Load the CSV-file
    ...
    def setup_gui(self):
        ...
        dayLabel = tk.Label(self.root, text="For how many days would you like to travel:", font=("Arial", 14), fg="black")
        dayLabel.place(x=0, y=300)
        ...
        dayOptions = ['', '1-3 days', '4-6 days', '7+ days']
        self.selected_day = tk.StringVar()
        self.selected_day.set(dayOptions[0])
        dayDropdown = tk.OptionMenu(self.root, self.selected_day, *dayOptions)
        dayDropdown.place(x=370, y=300)
    ...
    def get_recommendation(self):
        ...
        FEATURES = ["Category", "Best Time to Visit", "Cost of Living", "Days to Travel"]
        ...
        preferences_input = pd.DataFrame({
            ...
            'Days to Travel': [self.selected_day.get()]
        })
    ...
    - Days to Travel: {pred_row['Days to Travel'].iloc[0]}
